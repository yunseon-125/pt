...
public class Pager {
	...
	public static final int BLOCK_SCALE=10;//페이지 블록 갯수(10개)
	...
	public Pager(int count, int curPage) {
		...
		setBlockRange(); //페이비블럭의 범위 설정
	}
	
	//페이지블럭의 갯수 계산
	public void setTotBlock() {
		//991 : 991/10 =>99, 올림처리 ceil()
	...
	public void setBlockRange() {
		...
		//[이전]을 눌렀을 때 이동할 페이지, 현재블럭이 1이면 1로감,
		//[이전]이라는 표시는 빼야함
